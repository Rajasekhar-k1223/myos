...
SRCS_C = src/kernel.c src/gdt.c src/idt.c src/keyboard.c \
         ...
         src/task.c src/tss.c src/syscall.c src/user.c src/vesa.c src/bmp.c src/mouse.c src/wm.c src/snake.c src/calc.c src/clock.c src/wallpaper.c src/paint.c src/ata.c src/fs.c src/explorer.c src/speaker.c
