/* font8x8.h — Embedded 8×8 bitmap font (ASCII 32-127).
...
/* Draw a string at (x,y). Returns new x after last char. */
static inline int draw_string(unsigned int* fb, unsigned int pitch4,
